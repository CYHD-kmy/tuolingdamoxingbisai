...
| Web 看板 | `src/api/` | FastAPI 多页面看板 (首页/看板/历史/日报) + 8个 API 端点 |
...
| 质量 | ROE/毛利率 | 5% | 基本面过滤 |
| 风险 | 波动率适中 | 10% | 排除异常波动股 |
| 流动性 | 日均成交额 | 15% | > 5000 万，确保可交易 |

筛选流程: `5000+ → 剔除ST/停牌/新股 → 剔除成交额<5000万 → 多因子打分 → Top 20`
